...
RooWorkspace* GenerateSingleChannel( TString channelname/*, TString inputfile*/)
{
  ...
  */
  ...
  double setup_bkgextrap[5] = { input["bkgextrap"] , input["bkgextrap_low"] , 1 , 1 , 1 } ; // asymmetric uncertainty implemented with lognormal constraint
  NPmaker("bkgextrap", setup_bkgextrap,*&nuispara , *&constraints , *&globobs, *&expected_bkg);

  // =========================== Declare POIs ================================                                                                                                                        
  RooRealVar *mu = new RooRealVar("mu","mu",1,0,100);
  ...
  TString correlated = "mu,JESNP1,bkgextrap,lumi";
